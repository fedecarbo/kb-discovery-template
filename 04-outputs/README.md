...
This folder holds things shaped **for an audience**: not sources of truth, but deliverables built from them. Think show-and-tells, discovery readouts, stakeholder briefings, product vision structures.
...
- **Discovery readouts:** narrative summaries of what we've learned, shaped for a specific audience (CPCA, team, etc.).
